...
public class TezCrypt_Hand_StmDgst extends TezCrypt_Hand_BaseDgst<InputStream> {
    ...
    TezCrypt_Hand_StmDgst(TezCom_Proc<?, ?> previous) {
        super(previous);
    }
    ...
    byte[] onProcess(InputStream input) throws Exception {
        ...
        return BaseDigestCipher.digestInputStream(input, type);
    }
